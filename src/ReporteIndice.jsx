  ...
  return (
    <div style={{ maxWidth: 700, margin: "0 auto", padding: isMobile ? "32px 20px" : "48px 40px" }}>
      ...
      <button
        ...
        style={{ width: "100%", background: theme.purple, color: "#FFFFFF", border: "none", padding: "13px 0", fontFamily: theme.sans, fontSize: 16, fontWeight: 600, cursor: "pointer", borderRadius: 14 }}
      >
        Repetir el Índice →
      </button>
    </div>
